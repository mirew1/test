	...
	<div id="wrap">
		<div id="right_box">
	 	...
	 	<div id="left_box">
	 		...
	 		<div id="notice_box">	 			
	 			<p>공지사항<span class="btn_more"><a href="/classKing/views/member/notice.jsp">more <i class="fas fa-angle-right" style="vertical-align:middle;"></i></a></span></p>	 			
	 			<ul>
	 			...
	 			<ul id="ul_mc" class="owl-carousel owl-theme" style="padding:0px 20px">
	 				<li class="item">
	 					<div class="class_img_top" style="margin:none;">
	 						<a href="/classKing/views/class/classMake.jsp"><i class="fas fa-plus"></i></a>
	 					</div>
	 					<p>클래스 만들기</p>	 					
	 				</li>
	 				<li class="item">
	 					<div class="class_img_top" style="margin:none;">
	 						<a href="/classKing/views/class/classHome.jsp">
